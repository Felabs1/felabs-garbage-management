        ...
        <table class="w3-table w3-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td><button class="w3-button w3-grey w3-round" onclick="window.location.href = './edit_disposal.php?id=<?php echo $row['id']; ?>'">Edit</button><button class="w3-button w3-border w3-round">Delete</button></td>
                </tr>
            <?php
            }
            ?>
